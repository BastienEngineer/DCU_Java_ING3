...
public class Client {
	...
	public Client(String serverIP) {
		r=new Drone("A",100,100,0,"cyan",10);
	...
	/*
	 * getDate() allows to exchange strings in the example of the course. 
	 * However, using the Drone class, it sends and retrieves drones by 
	 * modifying the send and receive lines
	 */
	private void getDate() 
    {
        ...
        Drone r1;
        System.out.println("01. -> Sending Command (" + r.name + ") to the server...");
        this.send(r.name);
        try{
            r1 = (Drone) receive();
